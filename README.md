...
##  What’s Inside :
- Supervised ML models (Decision Tree, Random Forest, KNN, Logistic Regression, Naive Bayes)
- Unsupervised models (KMeans, DBSCAN, PCA)
- Data preprocessing & feature engineering
- Train–test split, cross validation
- Hyperparameter tuning (GridSearchCV / RandomizedSearchCV)
- ML pipelines for organized workflow
- Accuracy evaluation + performance visualizations  
- Easy-to-follow examples using real & synthetic datasets
...
• Understand different ML
algorithms
• Learn model training and evaluation
• Practice tuning and optimization
• Build clean ML pipelines
• Compare models visually
• Gain confidence through simple examples
...
```bash
# Clone the repo
git clone https://github.com/Aishwarya-Chandran/Machine-Learning-Programs.git
